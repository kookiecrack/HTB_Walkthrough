...
* Performed TCP and UDP scans using Nmap and Masscan.
```
kali@kali:~/HTB/academy$ sudo nmap -sC -sS -sV -A 10.10.10.215
[sudo] password for kali: 
Starting Nmap 7.91 ( https://nmap.org ) at 2020-11-10 02:12 EST
...
HOP RTT      ADDRESS
1   28.93 ms 10.10.14.1
2   28.95 ms 10.10.10.215
...
SF-Port33060-TCP:V=7.91%I=7%D=11/10%Time=5FAA3DDC%P=x86_64-pc-linux-gnu%r(
...
kali@kali:~/HTB/academy$ sudo masscan -p1-65535,U:1-65535 10.10.10.215 --rate=1000 -e tun0
[sudo] password for kali: 

Starting masscan 1.0.5 (http://bit.ly/14GZzcT) at 2020-11-10 07:12:03 GMT
